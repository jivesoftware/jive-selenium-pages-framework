...
/**
 * Created by charles.capps on 10/1/14.
 */
public class BrowserUtil {
     ...
     *
     * @param browser - this will probably only be useful for a {@link com.jivesoftware.selenium.pagefactory.framework.browser.web.WebBrowser}
     */
